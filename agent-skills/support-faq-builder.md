# Support FAQ Builder from Tutorials

> Draft a support FAQ from your tutorial channel.
...
## What it does
Point it at a how-to channel. It lists the videos, transcribes them, and drafts FAQ entries — question, answer, category, and a confidence score — each linked back to the source video for your team to review and publish.

## How it works
1. You pick your tutorial or how-to channel.
2. It transcribes the videos.
3. AI drafts question-and-answer FAQ entries.
4. You get draft FAQs with sources to review and publish.
