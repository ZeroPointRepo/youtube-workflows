...
> Vet a creator for brand-safety and fit before you partner.
...
## What it does
Give it a channel handle. It resolves the channel, samples a few recent transcripts, and scores brand-safety and fit with AI — returning a vetting row with a score, safety flags, and a rationale.

## How it works
1. You give it a creator's channel handle.
2. It samples a few recent videos and transcribes them.
3. AI scores brand-safety and fit and flags risks.
4. You get a vetting row with score, flags, and rationale.
