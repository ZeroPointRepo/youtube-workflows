# Video → Transcript → X (Twitter) Thread

> Turn a video into a ready-to-post 10-tweet X thread.
...
## What it does
Paste a YouTube link and get a numbered X (Twitter) thread — a hook, eight idea tweets, and a closing call to action.

## How it works
1. You paste a video link.
2. It fetches the transcript.
3. It writes a 10-tweet thread (hook, ideas, CTA).
4. You get ready-to-post thread text.
