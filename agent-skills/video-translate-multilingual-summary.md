# Video → Transcript → Translate → Multilingual Summary

> Get any video's gist, translated into the language you choose.
...
## What it does
Give it a video and a target language. It returns a translated title and a clean, bulleted summary written in that language.

## How it works
1. You give it a video link and a target language.
2. It fetches the transcript.
3. It translates and summarizes the content into your language.
4. You get a translated title, summary, and key topics.
