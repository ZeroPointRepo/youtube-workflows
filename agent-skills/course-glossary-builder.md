# Course Glossary Builder

> Build a study glossary from a course playlist.
...
## What it does
Give it a playlist. It transcribes the videos and extracts key terms with plain-English definitions, a source video and timestamp deep-link, and optional study notes — a ready-to-study glossary for learners.

## How it works
1. You give it a course or lecture playlist.
2. It transcribes the videos.
3. AI extracts key terms with plain-English definitions.
4. You get a glossary with timestamp deep-links and study notes.
