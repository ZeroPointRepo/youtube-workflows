# YouTube Citation Builder

> Generate APA, MLA, Chicago, and BibTeX citations for a video.
...
## What it does
Paste a URL. It transcribes with metadata and builds citation-ready references in four styles, plus a few timestamped snippet quotes with deep-links and in-text citations. No AI — deterministic, one transcript credit.

## How it works
1. You paste a video URL.
2. It reads the video's title and channel.
3. It builds APA, MLA, Chicago, and BibTeX citations.
4. You get timestamped snippet quotes to drop into a paper.
