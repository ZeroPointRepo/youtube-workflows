# Policy Speech Monitor

> Get a neutral Slack briefing whenever a policy channel posts.
...
## What it does
Track a government, think-tank, or policy channel. It checks daily, fires only on a genuinely new upload, transcribes it, and posts a factual summary — key points, stated positions, and notable quotes.

## How it works
1. You pick a policy channel to monitor.
2. It checks daily and fires only on a new upload.
3. It transcribes the video and summarizes it neutrally.
4. It posts key points and quotes to Slack.
