# Earnings-Call Tracker → Analyst Summary → Slack

> Get an analyst summary when a company posts an earnings call.
...
## What it does
Watch a company's investor-relations channel. When a new earnings call or update posts, it transcribes it and sends a concise analyst summary to Slack.

## How it works
1. You pick a company’s IR channel.
2. It watches for a new earnings call or update.
3. It transcribes the video.
4. It posts an analyst summary (numbers, highlights, risks) to Slack.
