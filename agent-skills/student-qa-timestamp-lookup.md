# Student Q&A → Video Timestamp Lookup

> Answer a question and point to the exact video moment.
...
## What it does
Ask a question about a course channel. It finds the right lecture, answers in plain English, and links the exact timestamps where it’s covered.

## How it works
1. You ask a question about a course channel.
2. It searches within the channel for the best lecture.
3. It transcribes and finds the answer.
4. You get the answer plus the exact timestamps.
