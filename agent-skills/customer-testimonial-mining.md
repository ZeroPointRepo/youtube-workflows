# Customer Testimonial Mining

> Mine ready-to-use customer quotes across a channel's videos.
...
## What it does
It transcribes recent videos with timestamps and uses AI to surface positive customer testimonials — each with a timestamp, the product or theme it praises, a confidence level, and a suggested marketing use.

## How it works
1. You pick a channel with customer or review videos.
2. It transcribes recent videos with timestamps.
3. AI surfaces positive testimonials and tags each one.
4. You get quotes with timestamps, themes, and suggested uses.
