# Multi-Video Topic Researcher → Research Brief

> Research a topic across YouTube and get one tidy brief.
...
## What it does
Type a search topic. It finds the top videos, reads the ones with captions, and writes a single research brief — summary, key themes, and where sources agree or disagree.

## How it works
1. You enter a topic to research.
2. It searches YouTube and picks the top videos.
3. It transcribes the ones with captions.
4. It writes one brief with themes, agreements, and takeaways.
