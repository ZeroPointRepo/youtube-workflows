# YouTube SEO Title & Description Analyzer

> See what's ranking for a keyword and how to beat it.
...
## What it does
Search a keyword and it studies the top videos — titles, views, lengths, and transcript snippets — then gives SEO patterns and title/description tips.

## How it works
1. You enter a keyword.
2. It finds the top-ranking videos and their stats.
3. It transcribes them and looks for patterns.
4. You get SEO patterns and concrete title/description tips.
