# Video → Transcript → LinkedIn Post

> Turn a video into a ready-to-post LinkedIn update.
...
## What it does
Paste a YouTube link and get a LinkedIn post — a strong hook, a punchy body, a call to action, and hashtags — ready to paste in.

## How it works
1. You paste a video link.
2. It fetches the transcript.
3. It writes a LinkedIn post with hook, body, CTA, and hashtags.
4. You copy the finished post and publish.
