# Weekly Industry Brief across Channels

> Get one weekly executive brief across many channels.
...
## What it does
Watch 5–10 channels. Once a week it reads their last 7 days of uploads and writes a single executive brief of what mattered.

## How it works
1. You list the channels to watch.
2. Each week it gathers their videos from the last 7 days.
3. It transcribes them.
4. It writes one combined executive brief and sends it to Slack.
