# New-Upload Monitor → Key Points → Slack Digest

> Get a Slack digest of key points whenever a channel posts.
...
## What it does
Watch any channel — a competitor, partner, or industry voice. When it posts a new video, you get the key takeaways in Slack.

## How it works
1. You pick a channel to watch.
2. It checks on a schedule for a brand-new upload.
3. When there’s a new one, it transcribes it and pulls the key points.
4. It posts a short digest to your Slack.
