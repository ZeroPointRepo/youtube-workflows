# Analyst Presentation Archiver

> Archive a research or IR channel's presentations into rows.
...
## What it does
Point it at a research or investor-relations channel. It lists the videos, transcribes each, and extracts a finance record — company, speaker, event type, summary, key statements, and risks — ready for a spreadsheet.

## How it works
1. You pick a research or investor-relations channel.
2. It lists and transcribes the presentations.
3. It extracts company, speaker, event, statements, and risks.
4. You get one structured archive row per presentation.
